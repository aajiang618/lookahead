/**
 * The four tab icons, traced from Heroicons (outline, 24px, MIT) — inlined
 * rather than installed, because four paths do not justify a dependency and
 * the offline build must not fetch anything.
 */
